      ...
      <main className={themeContext.theme} >
        ...
        <section className="about_box" >
          <article className="about__p">
            ...
            <p style={textStyle}>{userData.language === 'en' ? "I'm Seokye Lee. Born in Busan, South Korea, I dreamed and wondered since my childhood. I studied in the Art and Design and Cinematography sectors, I managed to work as head of the art direction department for films and series of television until I decided to resume my life after learning the emptiness of the word Success." : "Original de Busan, Corea del Sur, soñadora y curiosa. Licenciada en Cinematografia, trabajé como jefa del departamento de dirección de arte para cine y televisión hasta que decidí dar un giro a mi vida."}</p>
            ...
            <p style={textStyle}>{userData.language === 'en' ? "Graduated with an approved degree in the field of art, I continue to carry out professional training in Design of graphic products, in which I start in HTML and CSS. Interested in the digital world, I continued with the UX Design course: UDEMI user experience and the certified training on Web creation with WordPress. Currently finishing the specialized postgraduate degree in FrontEnd Web Design and Development at the Higher School of Art and Technology to achieve the goal of living from my passion." : "Comienzo a formarme en diseño de productos gráficos, donde me inicio en HTML y CSS. Continuo con el curso de Diseño UX: experiencia de usuario de UDEMI y formación certificada, sobre creación Web con WordPress. Actualmente terminando el postgrado especializado en Diseño y Desarrollo Web FrontEnd en la Escuela Superior de Arte y Tecnología."
            }</p>
